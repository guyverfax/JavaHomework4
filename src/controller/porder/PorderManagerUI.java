...
public class PorderManagerUI extends JFrame {
	...
	public PorderManagerUI() {
        ...
        JButton chartButton = new JButton("銷售圖表");
        chartButton.setFont(new Font("微軟正黑體", Font.BOLD, 12));
        chartButton.setBounds(170, 10, 96, 29);
        panel4.add(chartButton);
        ...
        chartButton.addActionListener(e -> {
        	new PorderSalesChartUI().setVisible(true);
        });
	...
	private PorderSalesChartUI PorderSalesChartUI() {
